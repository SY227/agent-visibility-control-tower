...
const DEFAULT_TRACE: WorkflowTraceItem[] = [
  ...
  },
  {
    ...
    status: "pending",
    summary: "Will model how an LLM may summarize the company from public pages and reveal the artifact preview.",
    evidenceCount: 0,
  },
  {
    id: "agent-visitor",
    ...
    status: "pending",
    summary: "Will assess what a machine visitor can and cannot act on, then surface the blocker artifact.",
    evidenceCount: 0,
  },
  {
    ...
    status: "pending",
    summary: "Will assess answer-engine readiness and AIO fit, then reveal findings.",
    evidenceCount: 0,
  },
  {
    ...
    status: "pending",
    summary: "Will look for proof, references, and citeable support gaps.",
    evidenceCount: 0,
  },
  {
    ...
    status: "pending",
    summary: "Will rank the highest-leverage fixes and assemble the Fix Pack.",
    evidenceCount: 0,
  },
];
